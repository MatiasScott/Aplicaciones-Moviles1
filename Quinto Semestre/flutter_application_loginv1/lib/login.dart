...
import 'package:flutter_application_loginv1/prueba.dart';
import 'dart:async';
...
class bloc_Login{  
  String userName = "";
  String password = "";
  final _counterStreamController =new StreamController<String>();
  Stream<String> get stream_counter=> _counterStreamController.stream;

  get context => null;

  void validacion(){
    if (userName.isEmpty && password.isEmpty) {
    content: Text("Bro no puedes dejar campos vacios, ayude llenando");
  } else {
      if (userName == "matias" && password == "12345") {
        content: Text("Okey entro al sistema");       
        } else {
          AlertDialog alert = AlertDialog(
            content: Text("El usuario o la contraseña son datos erroneos")                                
          );
          showDialog(
            context: context,
